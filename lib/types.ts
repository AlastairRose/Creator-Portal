...
// reposting, sorted oldest-last_posted_date-first wherever it's read so
// the most overdue-for-a-repost reel sits at the top.
export type WinningReel = {
  ...
  scheduled_for: string | null; // YYYY-MM-DD, null until staff picks a repost date
